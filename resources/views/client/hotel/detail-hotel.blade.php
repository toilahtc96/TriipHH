...
<div class="col-sm-12" style="width:100%; padding:4em 0">
    <div id="jssor_1"
        ...
        <div data-u="slides"
            ...
            <div>
                <img src="/images/roomhotels/{{$value}}" data-u="image" />
                <img src="/images/roomhotels/{{$value}}" data-u="thumb" />
            </div>
            @endforeach
            <a data-u="any" href="https://www.jssor.com" style="display:none">web animation composer</a>
        </div>
        <!-- Thumbnail Navigator -->
