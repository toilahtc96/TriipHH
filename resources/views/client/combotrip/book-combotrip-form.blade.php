    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Đặt phòng hạng <span id="level">{{$combo->level}} </span> của khách sạn
                    {{$combo->combo_trip_name}}
                </h4>
            </div>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-content-inner active" data-content="signup" style="padding:0 10% 0 10%">
                        ...
                        <div class="mt-3 mb-3">
                            ...
                            btn-block','onClick'=>'submitBookCombo()'])!!}
                            {!! Form::close() !!}
                        </div>
