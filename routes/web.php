...
Route::post('/getCarByDirection', 'Controller@getListCarOfDirectionAjaxActiveForCBB')->name('getCarByDirection');
Route::post('/getCombohot', 'Controller@getCombohotForFooter')->name('getCombohot');
